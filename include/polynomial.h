...
/**
 * @brief reset polynomial values to default
 * 
 * @param p 
 */
...
/**
 * @brief calculate polynomial arbitray precision value for x as int
 * 
 * @param acc 
 * @param x 
 * @param p 
...
/**
 * @brief calculate polynomial arbitray precision value for x as float
 * 
 * @param acc 
 * @param x 
 * @param p 

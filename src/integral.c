...
static polynomial_item_t riemann_sum_rect(
    polynomial_t *p,
    interval_t il,
    polynomial_item_t n)
{
...
static polynomial_item_t riemann_sum_trap(
    polynomial_t *p,
    interval_t il,
    polynomial_item_t n)
{
...
static polynomial_item_t riemann_sum_mp(
    polynomial_t *p,
    interval_t il,
    polynomial_item_t n)
{
...
static polynomial_item_t riemann_sum_left(
    polynomial_t *p,
    interval_t il,
    polynomial_item_t n)
{
...
static polynomial_item_t riemann_sum_right(
    polynomial_t *p,
    interval_t il,
    polynomial_item_t n)
{
